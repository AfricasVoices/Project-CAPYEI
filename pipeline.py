...
if __name__ == "__main__":
    ...
    parser.add_argument("demog_input_path", metavar="demog-input-path",
                        help="Path to demog JSON file, containing a list of serialized TracedData "
                             "objects")
    parser.add_argument("consent_input_path", metavar="consent-input-path",
                        help="Path to consent JSON file, containing a list of serialized TracedData "
                             "objects")
    ...
    parser.add_argument("icr_output_dir", metavar="icr-output-dir",
                        help="Directory to write CSV files to, each containing 250 messages and message ids for use " 
    ...
    consent_input_path = args.consent_input_path
    ...
    message_paths = [s02e01_input_path, consent_input_path]
