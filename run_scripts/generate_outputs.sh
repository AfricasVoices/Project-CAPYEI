...
./docker-run.sh ${CPU_PROFILE_ARG} ${DRIVE_UPLOAD_ARG} \
    ...
    "$DATA_ROOT/Raw Data/capyei_pp_survey.json" "$DATA_ROOT/Raw Data/capyei_demog_cleaned.json" \
    "$DATA_ROOT/Raw Data/consent_confirmation.json" "$DATA_ROOT/Coded Coda Files/" \
    ...
    "$DATA_ROOT/Outputs/capyei_production.csv"
